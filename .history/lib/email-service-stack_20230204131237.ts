...
export class EmailServiceStack extends Stack {
  ...
  constructor(scope: Construc, id: string, props?: StackProps) {
    super(scope, id, props);
    // create the SQS queue

    const stack: Construct = this;

    const orderQueue = new sqs.Queue(stack, 'OrderProcessingQueue', {
    ...
    const eventRule = new events.Rule(construct, "fiveMinuteRule", {
